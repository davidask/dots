...
- **Agents**: Agent skills and configuration in `~/.config/agents/` are stowed via the `agents` package. Skills are managed via `gh skills install --agent universal --scope user`.
